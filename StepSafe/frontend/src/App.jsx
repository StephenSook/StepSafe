...
const WOUND_LOCATIONS = [
  'Left Foot - Plantar (bottom)',
  'Left Foot - Dorsal (top)',
  'Right Foot - Plantar (bottom)',
...
function generateReportText(results, woundLocation, patientId) {
...
PATIENT INFORMATION
----------------------------------------
Patient ID / Room: ${patientId || 'Not specified'}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-[#0D9488]/30 focus:border-[#0D9488] transition-colors"
                    >
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-500 uppercase tracking-wide block mb-1.5">Patient ID / Room Number</label>
                    <input
                      type="text"
                      value={patientId}
                      onChange={e => setPatientId(e.target.value)}
                      placeholder="e.g. PT-4821 or Room 302"
                      className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-[#0D9488]/30 focus:border-[#0D9488] transition-colors placeholder:text-slate-400"
                    />
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-slate-50 rounded-xl p-3 max-h-48 overflow-y-auto border border-slate-100">
                      <pre className="text-xs text-slate-600 whitespace-pre-wrap font-mono leading-relaxed">
                        {generateReportText(results, woundLocation, patientId)}
                      </pre>
                    </div>
